...
final class DealCardUsecaseTests: CBSGameTests {
    func testDealingCardsToPlayer() throws{
        ...
        let gamePlayers = createGamePlayers(gameId: gameId, playerNames: [player1NameForTest, player2NameForTest, player3NameForTest, player4NameForTest])
        ...
        for player in gamePlayers {
            let player = game.getPlayer(byId: player.playerId)!
