...
extension PokeCard.Suit: CustomStringConvertible {
    public var description: String{
        return switch self {
            case .club:
                "♣️"
...
extension PokeCard: CustomStringConvertible {
...
extension PokeCard: Codable {

}

extension PokeCard.Suit: Codable {
    
}

extension PokeCard.Rank: Codable {
